...
class ChangePass extends Component {
    ...
    submitHandler = ( event ) => {
        ...
        const data = formData;
        axios.patch( 'http://127.0.0.1:5050/user/updateMyPassword/', data, {withCredentials:true} )
            .then( response => {
    ...
    render () {
        ...
        let form = (
            <form onSubmit={this.submitHandler}>
                ...
                <Button btnType="Success" disabled={!this.state.formIsValid}>Set New Password</Button>
            </form>
        );
